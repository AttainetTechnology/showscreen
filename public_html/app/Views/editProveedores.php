...
<form action="<?= base_url('proveedores/update/' . $proveedor['id_proveedor']) ?>" method="post"
    ...
    <div class="mb-2">
        ...
        <textarea name="observaciones_proveedor" id="observaciones_proveedor" class="form-control"
            rows="3"><?= $proveedor['observaciones_proveedor'] ?></textarea>
    </div>
    <div class="mb-2">
