    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const columnDefs = [
            ...
            cellRenderer: function (params) {
                let editBtn = '';
                <?php if (isset($nivel) && $nivel > 4): ?>
                editBtn = `<a href="<?= base_url('pedidos/edit/') ?>${params.data.id_pedido}" class="btn botonTabla btnEditarTabla">Editar
                ...
                // Mostrar el botón "Imprimir" si bt_imprimir es igual a 1 o $nivel es igual a 4
                const printBtn = (params.data.bt_imprimir == 1 <?php if (isset($nivel)) { echo "|| $nivel == 4"; } ?>)
