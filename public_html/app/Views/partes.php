<?php if (!empty($lineas)) { ?>
    <?php foreach ($lineas as $l) { ?>
                    ...
                    <?php foreach ($pedidos as $p) { ?>
                        <?php if (!empty($clientes)) { ?>
                            <?php foreach ($clientes as $cli) { ?>
                                ...
                                <?php } ?>
                            <?php } else {
                            echo "<div class='alert alert-warning'>No hay clientes disponibles.</div>";
                        } ?>
                        <?php } ?>
                    <?php } else {
                    echo "<div class='alert alert-warning'>No hay pedidos disponibles.</div>";
                } ?>
                <?php } ?>
            <?php } else {
        ...
        <?php } ?>
    <?php } else {
    echo "<div class='alert alert-warning'>No hay líneas disponibles.</div>";
} ?>