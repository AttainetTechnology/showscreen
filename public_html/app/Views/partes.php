    ...
    <?php foreach ($productos as $prod) { ?>
        <?php foreach ($pedidos as $p) { ?>
           ...
           <div id="parte_fila_right" class="imagenparte">
                ...
                <!-- Modificación de la ruta para incluir el id_producto -->
                <img src="<?php echo base_url("public/assets/uploads/files/" . $this->data['id_empresa'] . "/productos/" . $prod->id_producto . "/" . $prod->imagen); ?>" class="imagen_parte" /><br />
            </div>
                        <!-- END Cabecera -->
                    </div><!-- /.row -->
                    <!-- Table row -->
