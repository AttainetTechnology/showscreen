...
<style>
    .select2-container {
        width: 100% !important;
        /* Asegura que el ancho del dropdown coincida con el input */
    }
</style>
<br>
<h2>Añadir Ruta</h2>
...
<form id="add-form" action="<?= base_url('rutas/addRuta') ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="recogida_entrega" required>
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" name="fecha_ruta" value="<?= date('Y-m-d') ?>" required>
    </div>
    ...
    <div class="buttonsEditProductProveedAbajo">
        ...
        <button type="submit" class="boton btnAdd">Guardar Ruta
...
<script>
    $(document).ready(function () {
        ...
        $('#cliente').select2({
            placeholder: "Seleccione un cliente", // Texto por defecto
