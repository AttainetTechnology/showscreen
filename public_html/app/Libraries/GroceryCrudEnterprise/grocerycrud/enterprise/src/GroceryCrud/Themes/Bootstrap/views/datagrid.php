<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.9.5.c1d866c.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.9.5.c1d866c' . $minify_or_not . '.js');
